...
function generateStoryMarkup(story, showButton = false) {
...
function starFavorites(story, user) {
...
function putFavoritesOnPage() {
	...
	if (currentUser.favorites.length > 0) {
		...
		$favStories.append("<h4>No favorites</h4>");
	}
	$favStories.show();
}
...
async function switchStoryFavorite(evt) {
	console.log(evt);
...
$allStoriesList.on("click", switchStoryFavorite);
